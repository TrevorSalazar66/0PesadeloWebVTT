...
-- 1. Tabela de Usuários / Aventureiros
...
-- 2. Tabela de Sessões e Refresh Tokens
...
-- 3. Tabela de Campanhas / Mesas de RPG
...
-- 4. Tabela de Participantes da Campanha
...
-- 5. Tabela de Fichas de Personagens
...
-- Índices de Alta Performance para RLS (Row-Level Security)
